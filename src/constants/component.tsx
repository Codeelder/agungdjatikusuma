    ...
    return (
        <>
            ...
            <svg className="absolute right-0" width="93" height="200" viewBox="0 0 93 200" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <circle cx="100" cy="100" r="79" stroke="white" stroke-width="2" />
