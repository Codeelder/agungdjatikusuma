        ...
        >
          {MENUS.map((menu) => (
            <Link
              href={menu.href}
              key={menu.title}
              className="lineNavMenu md:lineNavMenu-none relative flex w-max items-center text-lg transition delay-150 ease-in md:font-medium md:hover:text-blueprimary"
            >
              {menu.title}
